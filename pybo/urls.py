...
#     # 답글 댓글용
#     path('comment/create/<int:answer_id>/', views.comment_create_answer, name='comment_create_answer'),
#     path('comment/modify/<int:comment_id>/', views.comment_modify_answer, name='comment_modify_answer'),
#     path('comment/delete/<int:comment_id>/', views.comment_delete_answer, name='comment_delete_answer'),
#     # 답댓글용
#     path('comment/create/<int:comment_id>/', views.comment_create_reply, name='comment_create_reply'),
# ]
